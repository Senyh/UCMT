...
def resnet18(in_channels=1, pretrained=False, progress=True, **kwargs):
...
def resnet34(in_channels=1, pretrained=False, progress=True, **kwargs):
...
def resnet50(in_channels=1, pretrained=False, progress=True, **kwargs):
...
def resnet101(in_channels=1, pretrained=False, progress=True, **kwargs):
...
def resnet152(in_channels=1, pretrained=False, progress=True, **kwargs):
...
def resnext50_32x4d(in_channels=1, pretrained=False, progress=True, **kwargs):
...
def resnext101_32x8d(in_channels=1, pretrained=False, progress=True, **kwargs):
...
def wide_resnet50_2(in_channels=1, pretrained=False, progress=True, **kwargs):
...
def wide_resnet101_2(in_channels=1, pretrained=False, progress=True, **kwargs):
...
if __name__ == '__main__':
    ...
    resnet = resnet50(in_channels=1, pretrained=True).to(device)
    out = resnet(tensor)
    print(out.shape)
